...
namespace Swarmops.Basic.Enums
{
    ...
    {
        public static readonly RoleType[] AllLocalRoleTypes =
        {
            RoleType.LocalLead,
        ...
        public static readonly RoleType[] AllOrganizationalRoleTypes =
        {
        ...
        public static readonly RoleType[] AllSystemRoleTypes =
        {
            RoleType.SystemAdmin,
            RoleType.SystemGeographyEditor
        };

        public static readonly RoleType[] AllRoleTypes = CreateAllRoleTypes();
