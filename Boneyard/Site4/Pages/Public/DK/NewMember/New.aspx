<%@ Page Language="C#" AutoEventWireup="true" CodeFile="New.aspx.cs" Inherits="Pages_Public_DK_NewMember_New" CodePage="65001" Culture="da-DK" UICulture="da-DK" meta:resourcekey="PageResource1" %>
...
<body>
    ...
    <div id="wrapper" style="margin-top: 50px; height: 341px;">
        <asp:Wizard ID="Wizard" runat="server" ActiveStepIndex="0" Width="500px" Height="333px" StartNextButtonText="Forts&auml;tt >>" StepNextButtonText="Forts&auml;tt >>" StepPreviousButtonText="<< Backa" FinishPreviousButtonText="Osynlig" FinishCompleteButtonText="Klart!" OnNextButtonClick="Wizard_NextButtonClick" OnFinishButtonClick="Wizard_FinishButtonClick" meta:resourcekey="WizardResource1">
            <WizardSteps>
                <asp:WizardStep ID="WizardStep1" runat="server" meta:resourcekey="WizardStep1Resource1">
                    ...
                    <asp:RadioButton ID="RadioParty" runat="server" Text="Piratpartiet, kostnadsfritt." GroupName="OrganizationSelect" meta:resourcekey="RadioPartyResource1" Visible="false" />
                    <br />
                    <asp:RadioButton ID="RadioYouthLeague" runat="server" Text="Jag &#228;r under 26, och vill g&#229; med i Ung Pirat (och Piratpartiet), kostnadsfritt." GroupName="OrganizationSelect" Checked="true" meta:resourcekey="RadioYouthLeagueResource1" Visible="false" />
                    <br />
                    <asp:RadioButton ID="RadioYouthLeagueOnly" runat="server" Text="Jag  vill g&#229; med i Ung Pirat (enbart), kostnadsfritt." GroupName="OrganizationSelect" Checked="true" meta:resourcekey="RadioYouthLeagueOnlyResource1" />
                    <br />
                    <br />
                    <asp:Label ID="LabelOrganizationError" runat="server" CssClass="ErrorMessage" meta:resourcekey="LabelOrganizationErrorResource1"></asp:Label>
                    <br />
                    <br />
                    ...
                    <br />
                    <asp:HyperLink ID="LinkLosenord" runat="server" Font-Size="Small" NavigateUrl="~/Pages/Public/SE/People/RequestNewPassword.aspx" meta:resourcekey="LinkLosenordResource1" Text="Återställ lösenord...">
                    </asp:HyperLink>
                    <asp:Literal ID="Literal29" runat="server" meta:resourcekey="Literal29Resource1">istället för att registrera dig på nytt här.</asp:Literal>
                ...
                <asp:WizardStep runat="server" ID="WizardStep3" meta:resourcekey="WizardStep3Resource1">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBirthDay" runat="server" Columns="1" meta:resourcekey="TextBirthDayResource1"></asp:TextBox>&nbsp;<asp:DropDownList ID="DropBirthMonths" runat="server" meta:resourcekey="DropBirthMonthsResource1">
                ...
                <asp:WizardStep runat="server" ID="WizardStep6" meta:resourcekey="WizardStep6Resource2">
                    ...
                    <p>
                        ...
                        :</p>
                    <br />
                    <asp:HyperLink href="http://www.piratpartiet.dk" Text="Piratpartiets hemsida" runat="server" /><br />
                    <br />
                    ...
                    <p>
                        ...
                        kan vi avhj&auml;lpa situationen.</asp:Literal>
                    </p>
                </asp:WizardStep>
            </WizardSteps>
