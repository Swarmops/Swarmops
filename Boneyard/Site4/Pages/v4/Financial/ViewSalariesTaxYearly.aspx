<%@ Page Language="C#" MasterPageFile="~/PirateWeb-v4.master" AutoEventWireup="true" CodeFile="ViewSalariesTaxYearly.aspx.cs" Inherits="Pages_v4_ViewSalariesTaxYearly" Title="View Yearly Salary Taxes - PirateWeb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" Runat="Server">
   ...
   <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    ...
    <pw4:PageTitle Icon="money_delete.png" Title="View Salary Tax Data" Description="View yearly salary tax data" runat="server" ID="PageTitle" />
