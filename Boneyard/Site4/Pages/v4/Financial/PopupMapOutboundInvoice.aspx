<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopupMapOutboundInvoice.aspx.cs" Inherits="Pages_v4_Financial_PopupMapOutboundInvoice" %>
...
<body style="background-color: #f8e7ff; padding-left:10px; padding-top:10px; padding-right: 10px; padding-bottom: 10px">
    ...
    <p><asp:RadioButton ID="RadioManualMap" AutoPostBack="true" GroupName="Actions" Checked="true" 
            runat="server" Text="Manually map this outbound invoice to a transaction?" 
    ...
    <p><asp:RadioButton ID="RadioCreditInvoice" runat="server" GroupName="Actions" AutoPostBack="true" 
            Text="Undo the invoice and issue a credit invoice?" 
            oncheckedchanged="RadioCreditInvoice_CheckedChanged" /></p>
    <hr />
