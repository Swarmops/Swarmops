<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopupEditBudget.aspx.cs" Inherits="Pages_v4_Accounting_PopupEditBudget" %>
...
<body style="background-color: #f8e7ff; padding-left:10px; padding-top:10px; padding-right: 10px; padding-bottom: 10px">
    ...
    <tr><td>Budget Year:&nbsp;</td><td><asp:Label ID="LabelBudgetYear" runat="server" /></td></tr>
    <tr><td>Yearly Budget:&nbsp;</td><td><asp:TextBox ID="TextBudget" runat="server" /></td></tr>
    <tr><td>&nbsp;</td><td><asp:Button ID="ButtonSetBudget" Text="Set Budget" runat="server" 
                    onclick="ButtonSetBudget_Click" /></td></tr>
