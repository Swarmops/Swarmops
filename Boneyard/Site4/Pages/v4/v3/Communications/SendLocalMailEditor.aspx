<%@ Page Language="C#" MasterPageFile="~/PirateWeb-v4.master" AutoEventWireup="true"
    CodeFile="SendLocalMailEditor.aspx.cs" Inherits="Pages_Communications_SendLocalMail_Editor"
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <div class="bodyContent">
        ...
        <asp:Panel ID="MainPanel" runat="server">
            ...
            :<br />
            <telerik:RadEditor ID="RadEditorBody" runat="server" AllowScripts="false" >
                <Content>
                </Content>
            </telerik:RadEditor>    
