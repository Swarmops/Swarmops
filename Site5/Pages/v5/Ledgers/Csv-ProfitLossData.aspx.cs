...
public partial class Pages_v5_Ledgers_Csv_ProfitLossData : DataV5Base
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("Content-Disposition",
            "attachment;filename=" + Resources.Pages.Ledgers.ProfitLossStatement_DownloadFileName +
        ...
        if (this._year == DateTime.Today.Year)
        {
            Response.Output.WriteLine("\"{0}\",\"{1}\",\"{2}\",\"{3}\",\"{4}\",\"{5}\",\"{6}\"",
                ...
                Resources.Pages.Ledgers.ProfitLossStatement_LastYear,
                Resources.Pages.Ledgers.ProfitLossStatement_Q1, Resources.Pages.Ledgers.ProfitLossStatement_Q2,
                Resources.Pages.Ledgers.ProfitLossStatement_Q3, Resources.Pages.Ledgers.ProfitLossStatement_Q4,
                Resources.Pages.Ledgers.ProfitLossStatement_Ytd);
        }
        else
        {
            Response.Output.WriteLine("\"{0}\",\"{1}\",\"{6}-{2}\",\"{6}-{3}\",\"{6}-{4}\",\"{6}-{5}\",\"{6}\"",
                Resources.Pages.Ledgers.ProfitLossStatement_AccountName, this._year - 1,
                Resources.Pages.Ledgers.ProfitLossStatement_Q1, Resources.Pages.Ledgers.ProfitLossStatement_Q2,
                Resources.Pages.Ledgers.ProfitLossStatement_Q3, Resources.Pages.Ledgers.ProfitLossStatement_Q4,
                this._year);
        }
