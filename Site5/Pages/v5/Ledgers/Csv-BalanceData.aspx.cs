...
public partial class Pages_v5_Ledgers_Csv_BalanceData : DataV5Base
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("Content-Disposition",
            "attachment;filename=" + Resources.Pages.Ledgers.BalanceSheet_DownloadFileName +
        ...
        Response.Output.WriteLine("\"{0}\",\"{1}\",\"{2}\",\"{3}\",\"{4}\",\"{5}\",\"{6}\"",
            Resources.Pages.Ledgers.ProfitLossStatement_AccountName,
            Resources.Pages.Ledgers.BalanceSheet_StartYear.Replace("XXXX",
                this._year.ToString(CultureInfo.InvariantCulture)),
            Resources.Pages.Ledgers.BalanceSheet_Q1, Resources.Pages.Ledgers.BalanceSheet_Q2,
            Resources.Pages.Ledgers.BalanceSheet_Q3, Resources.Pages.Ledgers.BalanceSheet_Q4,
            (this._year == DateTime.Today.Year
                ? Resources.Pages.Ledgers.BalanceSheet_Current
                : Resources.Pages.Ledgers.BalanceSheet_EndYear.Replace("XXXX",
                    this._year.ToString(CultureInfo.InvariantCulture))));
