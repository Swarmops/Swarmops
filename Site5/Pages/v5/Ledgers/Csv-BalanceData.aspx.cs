...
public partial class Pages_v5_Ledgers_Csv_BalanceData : DataV5Base
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("Content-Disposition", "attachment;filename=" + Resources.Pages_Ledgers.BalanceSheet_DownloadFileName + _year.ToString(CultureInfo.InvariantCulture) + "-" + DateTime.Today.ToString("yyyyMMdd") + ".csv");

        Response.Output.WriteLine("\"{0}\",\"{1}\",\"{2}\",\"{3}\",\"{4}\",\"{5}\",\"{6}\"", Resources.Pages_Ledgers.ProfitLossStatement_AccountName, Resources.Pages_Ledgers.BalanceSheet_StartYear.Replace("XXXX", _year.ToString(CultureInfo.InvariantCulture)),
            Resources.Pages_Ledgers.BalanceSheet_Q1, Resources.Pages_Ledgers.BalanceSheet_Q2, Resources.Pages_Ledgers.BalanceSheet_Q3, Resources.Pages_Ledgers.BalanceSheet_Q4,
            (_year == DateTime.Today.Year? Resources.Pages_Ledgers.BalanceSheet_Current : Resources.Pages_Ledgers.BalanceSheet_EndYear.Replace("XXXX", _year.ToString(CultureInfo.InvariantCulture))));
