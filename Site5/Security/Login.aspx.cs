...
namespace Swarmops.Pages.Security
{
    ...
    public partial class Login : DataV5Base // "Data" because we don't have a master page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string jsonTest = "{\"address\":\"foobar\",\"signature\":\"flerpbar\",\"uri\":\"herpderp\"}";
            BitIdCredentials credentialsTest = new JavaScriptSerializer().Deserialize<BitIdCredentials>(jsonTest);
