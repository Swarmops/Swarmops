...
namespace Swarmops
{
    public partial class MasterV5 : MasterV5Base
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!Request.Url.ToString().StartsWith("http://dev.activizr.com/") && !Request.Url.ToString().StartsWith("http://sandbox.swarmops.com") && !Request.Url.ToString().StartsWith("http://localhost:") && !Request.Url.ToString().StartsWith("http://cryptdb"))
                {
