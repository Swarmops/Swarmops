...
namespace Swarmops.Database
{
    public partial class SwarmDb
    {
        ...
        public BasicFinancialTransactionTagSetType[] GetFinancialTransactionTagSetTypes()
        {
            List<BasicFinancialTransactionTagSetType> result = new List<BasicFinancialTransactionTagSetType>();
