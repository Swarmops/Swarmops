...
namespace Swarmops.Database
{
    public partial class SwarmDb
    {
        ...
        private static BasicCommunicationTurnaround ReadCommunicationTurnaroundFromDataReader (IDataRecord reader)
        {
            ...
            return new BasicCommunicationTurnaround (organizationId, communicationTypeId, communicationId,
                dateTimeOpened,
        ...
        public void SetCommunicationTurnaroundResponded (int organizationId, int communicationTypeId,
            int communicationId,
