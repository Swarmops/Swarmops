...
{
    public partial class Json_ExpensableCostTypesTree : DataV5Base
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string cacheKey = "CostTypes-Json-" +
            ...
            FinancialAccounts accounts = this.CurrentOrganization.FinancialAccounts.ExpensableCostTypes;
