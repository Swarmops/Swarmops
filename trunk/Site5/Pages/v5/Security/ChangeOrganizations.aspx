...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderMain" Runat="Server">
    ...
    <span style="margin-left:12px"><asp:Label runat="server" ID="LabelCurrentOrganizationName" /></span>&nbsp;<br/>
        <select class="easyui-combotree" url="Json-AccessibleOrganizationsTree.aspx" name="OrganizationId" id="OrganizationId" animate="true" style="width:300px" height="30"></select>
