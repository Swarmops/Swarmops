<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonDetailPopup.ascx.cs" Inherits="Controls_v5_PersonDetailPopup" %>
...
<span style="line-height:150%"><asp:Label ID="LabelWriteLabel" runat="server" Text="Set new owner:" /><br /><act5:ComboPerson ID="PersonNewOwner" runat="server" OnSelectedPersonChanged="PersonNewOwner_SelectedPersonChanged" /></span><br />
