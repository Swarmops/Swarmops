...
public partial class Pages_Public_Hacks_Ballots2010 : System.Web.UI.Page
{
    ...
    System.Web.UI.WebControls.RepeaterItemEventArgs e)
    {
            ...
            (item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            {
                if (documentedCandidatesLookup.ContainsKey(candidate.Identity) || true)
                {
                    lines.Add(new CandidateLine(position, candidate,
                                                documentedCandidatesLookup.ContainsKey(candidate.Identity)));
                }
                position++;
            }
    ...
    protected class CandidateLine
    {
        ...
        public string FirstName { get { return this.person.Name.Split(' ')[0]; } }
        public string LastName { get { return this.person.Name.Substring(this.FirstName.Length + 1); } }
        public string PersonalNumber { get { return Formatting.CleanNumber(this.person.PersonalNumber); } }
