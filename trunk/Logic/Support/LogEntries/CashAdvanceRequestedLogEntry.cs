...
namespace Swarmops.Logic.Support.LogEntries
{
    ...
    public class CashAdvanceRequestedLogEntry: FinancialActionBase
    {
        ...
        public CashAdvanceRequestedLogEntry(Person requestingPerson, double amount, FinancialAccount budget, string reason)
        {
            this.Amount = amount;
            ...
            this.PersonId = requestingPerson.Identity; // do not save name for data retention reasons
        }
    }
}
