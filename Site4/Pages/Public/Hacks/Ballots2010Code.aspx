<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ballots2010Code.aspx.cs" Inherits="Pages_Public_Hacks_Ballots2010" %>
...
<ItemTemplate>
<%# Eval("PersonalNumber") %>;<%# Eval("FirstName") %>;<%# Eval("LastName")%>;<%# Eval("CityName") %>, <%# Eval("Age") %> år</ItemTemplate></asp:Repeater>
-----------------------------------------------------
