<%@ Page Title="" Language="C#" MasterPageFile="~/Master-v5.master" AutoEventWireup="true" Inherits="Swarmops.Frontend.Pages.v5.Admin.Hacks.PopulateFakePeople" Codebehind="PopulateFakePeople.aspx.cs" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PlaceHolderHead" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function uploadCompletedCallback() {
            ...
            $.ajax({
                type: "POST",
                url: "PopulateFakePeople.aspx/InitializeProcessing",
...
<asp:Content ID="Content5" ContentPlaceHolderID="PlaceHolderMain" Runat="Server">
    <div class="DivEntry">
        ...
        <div class="data-entry-labels">
            Upload <strong>fake people</strong> for processing<br/><br/>
        </div>
    </div>
    <div clear="both"></div>
    <div id="Processing">
