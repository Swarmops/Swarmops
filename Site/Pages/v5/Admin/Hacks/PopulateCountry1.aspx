<%@ Page Title="" Language="C#" MasterPageFile="~/Master-v5.master" AutoEventWireup="true" Inherits="Swarmops.Frontend.Pages.v5.Admin.Hacks.PopulateCountry1" Codebehind="PopulateCountry1.aspx.cs" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PlaceHolderHead" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function uploadCompletedCallback() {
            ...
            $.ajax({
                type: "POST",
                url: "PopulateCountry1.aspx/InitializeProcessing",
