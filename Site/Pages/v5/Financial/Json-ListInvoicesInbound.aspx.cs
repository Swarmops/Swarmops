...
public partial class Pages_v5_Finance_Json_ListInvoicesInbound : DataV5Base
{
    ...
    private string FormatAsJson()
    {
        ...
        string hasDoxString =
            "<img src='/Images/Icons/iconshock-search-256px.png' onmouseover=\\\"this.src='/Images/Icons/iconshock-search-hot-256px.png';\\\" onmouseout=\\\"this.src='/Images/Icons/iconshock-search-256px.png';\\\" baseid='I{6}' class='LocalViewDox' style='cursor:pointer' height='20' width='20' />";
