...
public partial class Pages_v5_Finance_Json_ValidatableReceipts : DataV5Base
{
    ...
    private string FormatAsJson (ExpenseClaims claims)
    {
        ...
        string hasDoxString =
            "<img src='/Images/Icons/iconshock-search-256px.png' onmouseover=\\\"this.src='/Images/Icons/iconshock-search-hot-256px.png';\\\" onmouseout=\\\"this.src='/Images/Icons/iconshock-search-256px.png';\\\" baseid=\\\"E{5}\\\" class=\\\"LocalViewDox\\\" height=\\\"18\\\" width=\\\"24\\\" style=\\\"cursor:pointer\\\" />";
        ...
        foreach (ExpenseClaim claim in claims)
        {
            ...
            result.AppendFormat (
                ...
                "<img id=\\\"IconDeniedE{5}\\\" class=\\\"LocalIconDenied\\\" baseid=\\\"E{5}\\\" height=\\\"18\\\" width=\\\"24\\\" /></span>\"",
