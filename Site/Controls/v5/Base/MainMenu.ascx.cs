...
namespace Swarmops.Controls.Base
{
    public partial class MainMenu : ControlV5Base
    {
        ...
        protected override void Render (HtmlTextWriter output)
        {
            ...
            output.Write("<li class='Disabled' dir='ltr'><a href='#builddata'><img src='/Images/PageIcons/transparency-16px.png' height='20' width='20' />" + String.Format(Resources.Menu5.Menu5_Beta_LinesOfCode, @"<!--KaylockCount-->160,861<!--EndKaylock-->") + "</a></li>");
