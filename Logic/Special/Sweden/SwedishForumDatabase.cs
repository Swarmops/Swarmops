...
namespace Swarmops.Logic.Special.Sweden
{
    ...
    {
        private const int ForumIdTestPost = 326;
        ...
        {
            get { return this.forceForumId != 0; }
            set
            {
                if (value)
                    this.forceForumId = ForumIdTestPost;
                else
                    this.forceForumId = 0;
            }
        }
        ...
        public int CreateNewPost(int forumId, Person poster, string title, string description, string post)
        {
            ...
            using (SqlConnection connection = new SqlConnection(this.connectString))
            {
                ...
                int postId = (int) parameterResult.Value;
    ...
    {
        private const int ForumIdTestPost = 262;
        // The cached values used by GetDatabase()
        private static string CachedConnectionString;

        private static readonly int partymembergroupid = 16;
        private static readonly int nonmembergroupid = 2;
        private readonly string connectString = string.Empty;
        private int forceForumId;
        ...
        public int CreateNewPost(int forumId, Person poster, string title, string description, string post)
        {
            ...
            if (this.forceForumId != 0)
                forumId = this.forceForumId;
