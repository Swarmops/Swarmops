    ...
    public class Memberships : List<Membership>
    {
        ...
        public static int GetMemberCountForOrganizationSince (int orgId, DateTime sinceDateTime)
        {
            return SwarmDb.GetDatabaseForReading()
                .GetMembershipCountForOrganizationsSince (new[] {orgId}, sinceDateTime);
        }
        ...
        {
            return
                FromArray (SwarmDb.GetDatabaseForReading().GetMemberships (organization, DatabaseCondition.ActiveTrue));
        }
        ...
        {
            return
                FromArray (SwarmDb.GetDatabaseForReading().GetMemberships (organizations, DatabaseCondition.ActiveTrue));
        }
