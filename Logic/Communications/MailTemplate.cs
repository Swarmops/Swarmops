...
namespace Swarmops.Logic.Communications
{
    ...
    {
        private readonly string originallyLoadedContent = "";
        ...
        public new string TemplateBody
        {
            get
            {
                ...
                {
                    return this.htmlDoc.DocumentNode.OuterHtml;
                }
        ...
        public string Html
        {
            get { return HtmlDoc.DocumentNode.OuterHtml; }
        }
        ...
        {
            this.htmlDoc = null;
            TemplateBody = this.originallyLoadedContent;
        }
