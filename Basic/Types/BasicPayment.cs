...
namespace Swarmops.Basic.Types
{
    ...
    {
        public BasicPayment (int paymentId, int paymentGroupId, Int64 amountCents, string reference, string fromAccount, string key, bool hasImage, int outboundInvoiceId)
        {
        ...
        public BasicPayment (BasicPayment original)
            : this (original.PaymentId, original.PaymentGroupId, original.AmountCents, original.Reference, original.FromAccount, original.Key, original.HasImage, original.OutboundInvoiceId)
        {
            // empty copy ctor
        }
